...
<form action="" method="post">
    ...
    开始: <input class="date2" name="startDate" type="text" id="datepicker1" onclick="new Calendar().show(this);"
               placeholder="必填"/>
    ----------结束: <input class="date2" name="endDate" type="text" id="datepicker2" onclick="new Calendar().show(this);"
                         placeholder="必填"/>
    <%if (UserManager.checkPermissions(user, Group.dealSend)) {%>
    <select name="dealsendid">
        ...
        <% for (int i = 0; i < listS.size(); i++) {
            ...
            User u = listS.get(i);
        %>
        <option value="<%=u.getId() %>"><%=u.getUsername() %>
        </option>
...
<form action="" method="post" onsubmit="return checkedd()">
    ...
    <select name="said" id="said">
        ...
        %>
        <option value="<%=sain.getId() %>"><%=sain.getSubmittime() + sain.getName() %>
        </option>
        <%
            }
        %>
...
<form>
    ...
    <input type="button" class="button" value="导出"
           onclick="javascript:window.location.href='ChargeExportServlet?said=<%=sa.getId() %>'"></input>
    ...
    <table border="1px" align="left">
        ...
        <tr id="<%=o.getId()%>" class="asc" onclick="updateClass(this)">
            ...
            <td align="center"><a href="javascript:void(0)"
                                  onclick="adddetail('dingdanDetail.jsp?id=<%=o.getId()%>')"><%=(o.getPrintlnid() == null ? "" : o.getPrintlnid())%>
            </a></td>
            <td align="center"><%=o.getbranchName(o.getBranch())%>
            </td>
            <td align="center"><input type="hidden" name="dealsendid"
                                      value="<%=o.getDealsendId()%>"/><%=o.getdealsendName()%>
            </td>
            <%
                if (o.getPhoneRemark() != 1) {
                    tdcol = "";
            ...
            %>
            <td align="center"><%=o.getUsername()  %><font color="<%= tdcol%>"><%=o.getPhone1()%>
            </font></td>
            ...
            <td align="center"><%=OrderManager.getDeliveryStatues(o)%>
            </td>
            <td align="center"><%=o.getRemark() %>
            </td>
            <%
            ...
            <td align="center"  <%=color%> rowspan="<%=count %> ">
                ...
                <input type="text" id="<%=orderid%>left" value="<%=price1%>" <%=isdisabel %> onBlur="addcount()"
